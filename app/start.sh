...
script_files=(check_deregistered.sh completed_task.py update_allocation.py starting.sh custom_conf.sh submitted_task.py cronjob.sh deRegister.sh delete_noti.sh displayStatus.sh domainPref.sh mentorAllocation.sh notification.sh setQuiz.sh submitTask.sh userGen.sh answerQuiz.sh)
